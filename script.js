const questions = [
  ...
  },
  {
    id: "E2",
    type: "choice",
    title: "当初の想定では、今ごろ目標の実現に必要なものは、どの程度揃っているはずでしたか？",
    options: [
      ["まだほとんど揃っていない想定だった", 0],
      ["一部は揃っている想定だった", 25],
      ["半分程度は揃っている想定だった", 50],
  ...
  },
  {
    id: "M2",
    type: "choice",
    title: "目標そのものは実現していても、当初思い描いていた形とは違っていた場合、どう感じますか？",
    options: [
      ["形は大きく違っても、目的が満たされれば構わない", 0],
      ["かなり違っていても、重要な部分が残れば構わない", 25],
      ["ある程度は思い描いた形であってほしい", 50],
      ["かなり思い描いた形に近くないと満足しにくい", 75],
